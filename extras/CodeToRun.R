...
outputFolder <- "D:/studyResults/cohortDiagnosticsStudy"
...
cohortTable <- "cohortDiagnosticsStudy"
...
privateKeyFileName <- ""
userName <- ""
cohortDiagnosticsStudy::uploadResults(outputFolder, privateKeyFileName, userName)
